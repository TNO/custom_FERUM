function [ G, grad_g ] = gfun(lsf,x,grad_flag,probdata,analysisopt,gfundata,femodel,randomfield)
        ...
        if grad_flag == 'no '
            ...
            if nx > 1
                ...
                for i = 1:nx
                    switch lower(gfundata(lsf).evaluator)
                        case 'basic'
                            [ g, dummy ] = gfunbasic(lsf,x(:,i),'no ',probdata,analysisopt,gfundata);
                            nfun = nfun+1;
                        otherwise
            ...
            elseif nthetag > 1
                ...
                for i = 1:nthetag
                    ...
                    switch lower(gfundata(lsf).evaluator)
                        case 'basic'
                            [ g, dummy ] = gfunbasic(lsf,x,'no ',probdata,analysisopt,gfundata);
                            nfun = nfun+1;
                        otherwise
        ...
        elseif grad_flag == 'ffd'
            ...
            for i = 1:nx
                ...
                for j = 1:nrv
                    ...
                    switch lower(gfundata(lsf).evaluator)
                        case 'basic'
                            [ g_a_step_ahead, dummy ] = gfunbasic(lsf,x,'no ',probdata,analysisopt,gfundata);
                            nfun = nfun+1;
                        otherwise
            ...
            for i = 1:nx
                ...
                for j = 1:nrv
                    ...
                    % use 'ddm' with the user specified partial derivative    
                        ...
                        [ ~, grad_g(j,i) ] = gfunbasic(lsf,x,'yes',probdata,analysisopt,gfundata);
                    end
                end
        ...
        if grad_flag == 'no '
            ...
            if nx > 1
                ...
                while k < nx
                    ...
                    switch lower(gfundata(lsf).evaluator)
                        case 'basic'
                            [ blockG, blockdummy ] = gfunbasic(lsf,blockx,'no ',probdata,analysisopt,gfundata);
                        otherwise
            ...
            elseif nthetag > 1
                ...
                while k < nthetag
                    ...
                    switch lower(gfundata(lsf).evaluator)
                        case 'basic'
                            [ blockG, blockdummy ] = gfunbasic(lsf,x,'no ',probdata,analysisopt,blockgfundata);
                        otherwise
