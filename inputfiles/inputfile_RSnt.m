...
probdata.marg =  [  1  (2+12)/2  (12-2)/sqrt(12)  (2+12)/2  nan  nan  nan  nan 0 ;
                    1   (0+4)/2   (4-0)/sqrt(12)   (0+4)/2  nan  nan  nan  nan 0 ];
probdata.marg =  [  1  (2+12)/2  (12-2)/sqrt(12)  (2+12)/2      nan             nan                            nan                       nan 0 ;
                   51       nan              nan         3  (0+4)/2  (4-0)/sqrt(12)  (0+4)/2-(-0.5)*(4-0)/sqrt(12)  (0+4)/2+3*(4-0)/sqrt(12) 1 ];

% Correlation matrix
probdata.correlation = [ 1 0 ;
                         0 1 ];
