% Reference value for pf: pf = 2.69e-007
...
probdata.marg =  [  1  10  0.5  10  nan  nan  nan  nan 0;
                    1   0    1   0  nan  nan  nan  nan 0;
                    1   4    1   4  nan  nan  nan  nan 0 ];
...
analysisopt.block_size           = 1e7;      % Number of g-calls to be sent simultaneously
% block_size = 1e7 works well on a 4Gb RAM PC. A CMC simulation with 1e9 samples takes about 45 min.
...
analysisopt.num_sim              = 1e9;      % Number of samples (MC,IS), number of samples per subset step (SS) or number of directions (DS)
...
analysisopt.target_cov           = 0.001;    % Target coefficient of variation for failure probability
analysisopt.lowRAM               = 1;        % 1: memory savings allowed, 0: no memory savings allowed
...
gfundata(1).expression = 'gfun_AE10(x1,x2,x3)';
