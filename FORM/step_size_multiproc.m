function step_size = step_size_multiproc(lsf,G,grad_G,u,d,probdata,analysisopt,gfundata,femodel,randomfield)
...
switch analysisopt.multi_proc
	...
	case 0
   	...
   	trial_u = Trial_u(:,1);
		trial_x = Trial_x(:,1);
		[ trial_G, dummy ] = gfun(lsf,trial_x,'no ',probdata,analysisopt,gfundata,femodel,randomfield);
