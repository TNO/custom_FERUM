...
probdata.marg =  [  1  3  1  3  nan  nan  nan  nan 0 ;
                    1  5  2  5  nan  nan  nan  nan 0 ];

% Correlation matrix
probdata.correlation = [ 1.0  0.5
                         0.5  1.0 ];
...
gfundata(1).expression = 'epsilon*(2*x1.*x2-y)';
